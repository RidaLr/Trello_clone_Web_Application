...
var author$project$Register$initialModel = {email: '', emailStatus: author$project$Register$NotAnEmail, name: '', password1: '', password2: '', passwordCheck: author$project$Register$Password1NotDone};
...
var author$project$Register$NameUpdated = function (a) {
...
var author$project$Register$isFormValid = function (model) {
	return (model.name !== '') && ((model.password1 !== '') && (_Utils_eq(model.password1, model.password2) && _Utils_eq(model.emailStatus, author$project$Register$Free)));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onInput(author$project$Register$NameUpdated)
							]),
						_List_Nil)
					])),
				A2(
